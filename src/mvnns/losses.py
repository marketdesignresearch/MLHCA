...
def NOMU_loss(mean_output,
    ...
    # ----------------------------------------------------------
    # NOTE: loss_a is for training the mean model 
    ...
    # NOTE: loss_b corresponds to loss 9a in the paer (+ the two extra fancy terms)
    ...
    # NOTE:  loss_c corresponds to losses 9c and 9d in the paper 


    return loss_a, loss_b, loss_c


def NOMU_loss_hybrid(ub_output,
              X_train,
              target,
              pi_sqr,
              pi_exp,
    ...
    '''
    Returns NOMU hybrid loss for outputs given a single batch.
    Only returns the loss that corresponds to the uncertainty part. 
    '''
    ...
    # NOTE: loss_b corresponds to loss 9a in the paper (+ the two extra fancy terms)
    # ADD the DQ data to the B LOSS
