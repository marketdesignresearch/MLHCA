...
class MLCA_DQ_ECONOMIES:
    ...
    def __init__(self,
        ...
        if self.wandb_tracking: 
            ...
            wandb.define_metric('ML train time', step_metric="iterations")
            wandb.define_metric('price calculation time', step_metric="iterations")
    ...
    def save_results(self,
        ...
        if self.wandb_tracking and not no_wandb_logging:
            ...
            wandb_dict = {"Efficiency Clock Bids": self.efficiency_per_iteration[self.mlca_iteration],
                        ...
                        "Price Calculation Time": self.ML_price_vector_generation_time_current_iteration
                        }
